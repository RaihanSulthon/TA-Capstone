  ...
  return (
    <>
      ...
      <button
        ...
        className={`relative p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-opacity-50 hover:scale-105 hover:shadow-xl duration-300 ${
          isAdmin
            ? "text-white hover:border hover:border-white focus:ring-white"
            : "text-gray-600 hover:text-gray-800 hover:bg-blue-200 focus:ring-blue-500"
        }`}>
        <svg
          className="h-6 w-6"
          fill="none"
