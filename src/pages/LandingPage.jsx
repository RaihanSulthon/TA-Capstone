...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Fixed Navbar */}
      <nav
        className={`fixed top-0 left-0 right-0 z-[1000] py-3 transition-all duration-200 ${
          isScrolled
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button
                ...
                className={`font-medium transition-all duration-300 px-3 py-2 rounded hover:shadow-md ${
                  ...
                  activeSection === "home" &&
                  (isScrolled ? "text-blue-600" : "font-semibold")
                }
                `}>
                Home
              </button>
            ...
            <div className="hidden md:flex items-center space-x-4">
              {isAuthenticated ? (
                <Button
                  ...
                  className="bg-blue-600 border-1 border-blue-500 hover:bg-white hover:text-blue-600 px-5 py-2 rounded-lg font-semibold hover:scale-105 transition-all duration-300">
                  Dashboard
                </Button>
              ) : (
                <>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              A comprehensive platform for Telkom University students and
              lecturers
            </p>
              ...
              {isAuthenticated ? (
                ...
                <>
                  <Button
                    ...
                    className="bg-transparent border-2 border-white hover:bg-white hover:text-blue-600 px-8 py-3 rounded-lg font-semibold transition-all hover:scale-105 duration-300">
                    Get Started
                  </Button>
                  <Button
                    onClick={() => scrollToSection(laakRef)}
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2 md:pl-10">
              ...
              <p className="text-gray-600 mb-4">
                This capstone project was developed as part of the curriculum at
                Telkom University. It aims to provide a comprehensive platform
                for students and organizations to collaborate, share resources,
                and manage academic activities.
              </p>
              <p className="text-gray-600 mb-6">
                The application includes various features such as user
                authentication, role-based access control, and a responsive
                design for optimal user experience on all devices.
              </p>
              {isAuthenticated ? (
                <Button
                  onClick={() => navigate("/app/dashboard")}
                  className="bg-blue-600 border-1 border-blue-500 hover:bg-white hover:text-blue-600 px-5 py-2 rounded-lg font-semibold transition-all hover:scale-105 duration-300">
                  Go to Dashboard
                </Button>
              ) : (
                <Button
      ...
      <section ref={laakRef} id="laak-info" className="py-16 bg-blue-50">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-lg border border-blue-200 p-8 text-center">
            ...
            <p className="text-gray-600 mb-8">
              Akses informasi dan layanan administrasi akademik & kemahasiswaan
              Fakultas Informatika
            </p>
            <button
              onClick={() => navigate("/laak-info")}
              className="inline-flex items-center bg-blue-600 border-2 border-blue-500 hover:bg-white hover:text-blue-600 text-white px-8 py-4 rounded-lg font-semibold transition-all hover:scale-105 duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-700 mt-8 pt-6 text-center">
            <p className="text-sm text-gray-400">
              &copy; {new Date().getFullYear()} My Capstone App. All rights
              reserved.
            </p>
          </div>
        </div>
