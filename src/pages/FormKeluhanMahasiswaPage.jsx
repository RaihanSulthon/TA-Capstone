    ...
    try {
      ...
      console.log("Ticket data size check:", {
        estimatedDocumentSize:
          JSON.stringify(ticketData).length + " characters",
        hasAttachment: !!lampiranBase64,
        attachmentSize: lampiranBase64
          ? formatFileSize(lampiranBase64.length)
          : "0KB",
      });
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-8">
              ...
              <div className="mb-2 p-4 bg-purple-50 border border-purple-200 rounded-md">
                ...
                <p className="text-xs text-gray-600 mt-1 ml-6">
                  Jika dicentang, identitas Anda tidak akan ditampilkan dalam
                  laporan.
                  {formData.anonymous &&
                    " Token rahasia akan dibuat untuk verifikasi."}
                </p>
              </div>
              <div className="mb-4 text-sm text-gray-600">
                {formData.anonymous && (
                  <p className="mt-1 text-purple-600 font-medium">
                    ⚠️ Token rahasia akan dibuat untuk verifikasi kepemilikan
                    tiket anonymous.
                  </p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    {formData.kategori &&
                      subKategoriOptions[formData.kategori]?.map((option) => (
                        <option key={option.value} value={option.value}>
                          {option.label}
                        </option>
                      ))}
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="text-sm text-blue-800">
                      ...
                      <ul className="space-y-1">
                        <li>
                          • <strong>Ukuran maksimal:</strong> 750KB (~0.75MB)
                        </li>
                        <li>
                          • <strong>Format didukung:</strong> Gambar (JPG, PNG,
                          GIF), PDF, Word, Excel, Text
                        </li>
                        <li>
                          • <strong>Tips:</strong> Kompres gambar atau gunakan
                          format JPG untuk ukuran lebih kecil
                        </li>
                        <li>
                          • <strong>Catatan:</strong> File lebih besar dari
                          750KB akan otomatis ditolak
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        ...
                        <p className="text-xs text-gray-500">
                          Maksimal 750KB • JPG, PNG, PDF, Word, Excel, Text
                        </p>
                      </div>
                      <input
                        type="file"
            ...
            <div className="mt-6 flex justify-end">
              <Button
                type="submit"
                disabled={loading}
                className="bg-blue-600 border-1 border-blue-500 hover:bg-white hover:text-blue-600 rounded-lg font-semibold transition-all hover:scale-105 hover:shadow-xl duration-300 px-6 py-3">
