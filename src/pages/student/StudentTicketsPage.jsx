    ...
    <div className="max-w-7xl mx-auto px-3 md:px-4 py-4 md:py-6 overflow-x-hidden w-full">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 md:mb-6 gap-3">
        ...
        <div className="flex-shrink-0">
          <Button
            ...
            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 px-4 py-2 text-sm"
          >
            Buat Tiket Baru
          </Button>
        </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-4 mb-4 md:mb-6 overflow-hidden w-full">
        ...
        <div className="bg-white p-3 md:p-4 rounded-lg shadow-md">
          ...
          <p className="text-lg md:text-2xl font-bold text-orange-600">{ticketStats.totalFeedbacks}</p>
        </div>
      </div>
            ...
            <div className="divide-y divide-gray-200">
              {loading ? (
                ...
                currentTickets.map((ticket) => {
                  ...
                  return(
                    <div key={ticket.id} className={`p-3 ${hasFeedback ? "bg-purple-50" : isUnread ? "bg-blue-50" : ""} overflow-hidden`}>
              ...
              <div className="hidden md:flex md:items-center md:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    Showing{' '}
                    <span className="font-medium">{indexOfFirstTicket + 1}</span>
                    {' '}to{' '}
