...
const TicketManagementPage = () => {
  ...
  const getFeedbackInfo = (ticketId) => {
    const counts = feedbackCounts[ticketId] || {
      total: 0,
      unreadByAdmin: 0,
      unreadByStudent: 0,
    };
    return {
      total: counts.total,
      unread:
        userRole === "admin" ? counts.unreadByAdmin : counts.unreadByStudent,
    };
  };
      ...
      >
        <div>
          ...
          <p className="text-red-600 text-sm mb-6">
            <strong>Perhatian:</strong> Tindakan ini akan menghapus tiket secara
            permanen bagi semua pengguna termasuk mahasiswa.
          </p>
