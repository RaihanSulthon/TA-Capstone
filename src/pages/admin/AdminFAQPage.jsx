    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <Button
          ...
          className="bg-blue-600 text-white hover:bg-white hover:text-blue-600 border border-blue-600 transition-colors duration-200 w-full sm:w-auto"
        >
          Tambah FAQ
        </Button>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2">
            <button
              ...
              className="w-full px-4 py-2 text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-md transition-colors duration-200"
            >
              Reset Filter
            </button>
          </div>
            ...
            {currentFAQs.map((faq, index) => (
              <div key={faq.id} className="p-4 hover:bg-gray-50">
                ...
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex gap-1 ml-2">
                    <button
                      ...
                      className="px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-white hover:text-blue-600 border-blue-500 border-1 transition-colors duration-300"
                    >
                      Detail
                    </button>
                    <button
                      onClick={() => openDeleteModal(faq)}
                      className="px-3 py-1 text-xs bg-red-600 text-white rounded hover:bg-white hover:text-red-600 border-red-500 border-1 transition-colors duration-300"
                    >
                      Hapus
                    </button>
                  </div>
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  <div>
                    <span className="font-medium">Kategori:</span> {getCategoryLabel(faq.category)}
                  </div>
                  <div>
                    <span className="font-medium">Jawaban:</span> {faq.answer?.substring(0, 100)}...
                  </div>
                </div>
              </div>
            ))}
